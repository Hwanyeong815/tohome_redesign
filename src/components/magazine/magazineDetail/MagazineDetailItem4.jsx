    ...
    return (
        <MagazineDetailItem4Style>
            ...
            <div className="steps-wrap">
                <div className="steps steps1 " ref={addToRefs}>
                ...
                <div className="steps steps2" ref={addToRefs}>
                    <div className="img-wrap">
                ...
                <div className="steps steps3" ref={addToRefs}>
                    <div className="img-wrap">
                ...
                <div className="steps steps4" ref={addToRefs}>
                    <div className="img-wrap">
                ...
                <div className="steps steps5" ref={addToRefs}>
                    <div className="img-wrap">
                ...
                <div className="steps steps6" ref={addToRefs}>
                    <div className="img-wrap">
