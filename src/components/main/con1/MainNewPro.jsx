...
즐겨보세요.`,
    ...
    },
    {
        title: '경복궁BLACK',
        subtitle: '한우 떡갈비 >',
        description: `경복궁 블랙의 한우 떡갈비는 짝갈비를 통재로 갈아 넣어 둥글게 빚었습니다.
국내산 배를 사용한 경복궁만의 전통 양념으로 달콤하면서 짭조름한 것이 특징입니다. \n 샌드위치, 햄버거 속재료로 활용해도 좋습니다.`,
        highlightText: '한우 짝갈비가 들어간 달콤한 떡갈비',
        img: '/images/product/product07.png',
    },
    {
        title: '상어알분식',
        subtitle: '한우 한입 쌀 떡볶이 >',
        description: `학교 앞 분식점에서 팔던 쫀득쫀득
쌀떡파들을 만족 시킬 상어알분식의 가래떡쌀떡볶이 입니다. 알룰로스로 단맛은 채우고 당과
