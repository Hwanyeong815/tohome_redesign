...
const MainRecom = () => {
    ...
    const ClickableTxts = () => (
        <div className="txts">
            <p
                className={activeIndex === 0 ? 'on' : ''}
                onClick={() => goSlide(0)}
            >
                MD’s PICK
            </p>
            <p
                className={activeIndex === 1 ? 'on' : ''}
                onClick={() => goSlide(1)}
            >
                오늘의 타임특가
            </p>
            <p
                className={activeIndex === 2 ? 'on' : ''}
                onClick={() => goSlide(2)}
            >
                오늘의 브랜드
            </p>
        ...
        <>
            ...
            >
                <SwiperSlide>
                    <img
                        className="back"
                        src="/images/main/mainRecom1.png"
                        alt=""
                    />
                    ...
                    <section>
                        <div className="left">
                            <strong className="pretendard fw400">
                                MD&apos;s PICK
                            </strong>
                            <h2>[블랑제리코팡] 바삭한 치즈 스콘</h2>
                            <div className="txt pretendard fw300">
                                <p>
                                    일반적인 스콘과 다른 특이한 모양의 매력적인
                                    스콘.
                                </p>
                                <p>
                                    노르스름한 색감이 먹음직스럽고 치즈의
                                    풍미까지
                                </p>
                                <p>
                                    즐길 수 있어 기존 스콘보다 진한 맛을 원하는
                                    이들에게
                                </p>
                                <p>제격입니다.</p>
                            </div>
                ...
                <SwiperSlide>
                    <img
                        className="back"
                        src="/images/main/mainRecom2.png"
                        alt=""
                    />
                    <h3 className="sub-title">
                    ...
                    <section>
                        <div className="left">
                            ...
                            <h2>
                                [modoo] 모두의 데일리 서리태 볶음콩 (33입/박스)
                            </h2>
                            <div className="txt pretendard fw300">
                                <p>
                                    건강한 간식으로 사랑받는 서리태 볶음콩
                                    선물세트를
                                </p>
                ...
                <SwiperSlide>
                    <img
                        className="back"
                        src="/images/main/mainRecom3.png"
                        alt=""
                    />
                    <h3 className="sub-title">
                        현대식품관이 먼저 담아본 브랜드, 좋은 식품은 좋은
                        브랜드에서 시작됩니다
                    </h3>
                    <section>
                        <div className="left">
