      ...
      <div className="boxWrap">
        <div className="box">
          ...
          <div className="article">
            <div className="txt">
              <p>
                결제완료 이후 주문의 상태가 ‘상품준비중’으로 변경될 경우, 취소가
                제한됩니다.
              </p>
              <p>
              ...
              <p>
                ...
                H.Bonus, 쿠폰 등은 모두 복원됩니다. <br /> 단, 취소시 사용기한이
                지난 혜택은 복원되지 않습니다.
              </p>
            </div>
          </div>
        ...
        <div className="box">
          ...
          <div className="article">
            ...
            <div className="txt">
              ...
              <span>3개월 이내에 사진과 함께 1:1문의 게시판에 등록하시면,</span>
              <span>담당자 확인 후 교환/반품이 진행됩니다.</span>
              <span>
              ...
              <span>
                최대 7일 이내에 사진과 함께 1:1문의 게시판에 등록하시면, 담당자
                확인 후 교환/반품이 진행됩니다.
              </span>
              <span>
