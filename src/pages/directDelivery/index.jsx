                ...
                <div className="banner">
                    <div className="left">
                        <div className="points">
                            <div className="point">
                                <div className="title">
                                    <span>Point 1</span> 브랜드가 직접 선택한
                                    신뢰 배송
                                </div>
                                <div className="desc">
                                    상품 준비 상황에 따라 브랜드가 직접 가장
                                    최적의 배송 방법을 선택해, 신선함과 품질을
                                    그대로 전합니다.
                                </div>
                            </div>
                            <div className="row">
                                <div className="point">
                                    <div className="title">
                                        <span>Point 2</span> MD의 안목으로 고른
                                        검증된 브랜드
                                    </div>
                                    <div className="desc">
                                        현대식품관 투홈 MD가 지금 가장 주목받는,
                                        믿고 추천할 수 있는 브랜드만을
                                        엄선했습니다.
                                    </div>
                                </div>
                    ...
                    <div className="right">
                        <img
                            src="/images/directDelivery/bannerImg.png"
                            alt=""
                        />
                    </div>
                </div>
