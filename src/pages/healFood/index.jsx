            ...
            <div className="inner">
                <section>
                    <div className="info">
                        ...
                        >
                            매주 한 번, 메디쏠라의 건강식품으로 건강한 식탁을
                            차려보세요.
                            <br />
                            당뇨, 암, 신장, 저당 등 맞춤형 식단으로 각자의
                            건강을 챙기고, <br className="mobileOnly" /> 신선한
                            재료로 정성껏 준비된 식사를 제공합니다.
                            <br />
                            매주 다양한 메뉴로 가족 모두의 건강을 지키고,
                            <br className="mobileOnly" /> 맛있고 건강한 식사를
                            즐겨보세요.
                        </p>
                    </div>
                    <div className="list">
                        <div
                            className="meal item1"
                            data-aos="fade-up"
                            data-aos-duration="500"
                        >
                            <div className="imgs">
                                <img
                                    src="images/healfood/healfood01.jpg"
                                    alt="당뇨케어 식단"
                                />
                            </div>
                        ...
                        >
                            <div className="imgs">
                                <img
                                    src="images/healfood/healfood02.jpg"
                                    alt="암케어 식단"
                                />
                            </div>
                        ...
                        >
                            <div className="imgs">
                                <img
                                    src="images/healfood/healfood03.jpg"
                                    alt="신장케어 식단"
                                />
                            </div>
                        ...
                        >
                            <div className="imgs">
                                <img
                                    src="images/healfood/healfood04.jpg"
                                    alt="저당관리 식단"
                                />
                            </div>
